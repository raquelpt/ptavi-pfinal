        ...
        Metodo = line.split(" ")[0]
          ...
          self.wfile.write("SIP/2.0 400 Bad Request" + "\r\n\r\n")
            ...
            if expires == "0":
                ...
                fich.write(str(time.time()) + " Register " + direccion + "\r\n")
	...
	"""
        ...
        for clave in dicc:
            if clave == Destinatario:
				...
				#una vez que nos hemos atado, analizamos el metodo del que se trata
        ...
        if Cliente != Destinatario:
			#Si el destinatario no se encuentra en nuestro diccionario como cliente
...
if __name__ == "__main__":
    ...
    print "Server: " + Server + " listening at port " + PUERTO_PROX + "..." + "\r\n"
    print "Listening..."
